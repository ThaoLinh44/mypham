                    ...
                    <div id="noidungchinh">
                        ...
                        <div id="sanphammoi">
                           <h3>  <?php
                            if (isset($_GET['id'])) {
                                $id=$_GET['id'];
                                $lenh2 = "select * from nhomchamsoc where maloai='cs' AND manhom='$id' ";
                        ...
                        ?></h3>
                            ...
                            if (isset($_GET['id'])) {
                                $id=$_GET['id'];
                                $lenh2 = "select * from hanghoa where maloai='cs' AND manhom='$id' ";
                                $kq2 = mysqli_query($conn, $lenh2);
                                if(mysqli_num_rows($kq2) > 0){
                                    while ($row2 = mysqli_fetch_assoc($kq2)){
                                        echo "<div class=\"sp\">";
        ...
        <div id="toancuc">             
                ...
                <div id="noidung">
                    ...
                    <div id="menu2">
                     ...
                     <div align="center" id="slogan">
                    <img src="bg/oke.png" width="1110px" height="300px">
                 </div>
                     <br>
                    <div id="noidungchinh">
                        ...
                        <br>&emsp;&emsp;
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                if(mysqli_num_rows($kq2) > 0){
                                    while ($row2 = mysqli_fetch_assoc($kq2)){
                                        echo "<div class=\"sp\">";
                                        echo("<a href=\"sanpham.php?id=".$row2['mahang'] ."\" target=\"\"><img src=\"hinh/" .$row2['hinh'] ."\" width=\"100%\" height=\"250px\"
        ></a>" ); 
                                        echo"<br>";
                                        echo"<br>";
